...
{
public:
	float flt_0010; //0x0010
	float flt_0014; //0x0014
	float flt_0018; //0x0018
	float flt_001C; //0x001C
	float flt_0020; //0x0020
	float flt_0024; //0x0024
}; //Size: 0x0028
...
public:
	...
	uint32 dangerEventSubtype; //0x0050 // DangerEvent::SubType
